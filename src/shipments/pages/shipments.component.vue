...
export default {
  ...
  methods: {
    filterData() {
      this.$refs.ShipmentList.filterContent(
        this.$refs.ShipmentFilter.selectedItem
      );
    },
    addNewItem() {
      const result = this.$refs.ShipmentList.addNewItem(
        this.$refs.ShipmentForm.shipment,
        this.$refs.ShipmentForm.isValid
      );
      if (result) {
        this.$refs.ShipmentForm.shipment = {};
