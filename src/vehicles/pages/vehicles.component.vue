<template>
  <div class="container">
    <div class="flex flex-column space-between align-items-center">
      <vehicles-list ref="VehicleList" :enableListDialogs="enableListDialogs" @showDialog="enableDialog"></vehicles-list>
...
export default {
  ...
  methods: {
    addNewItem(){
      const result = this.$refs.VehicleList.addNewItem(this.$refs.VehicleForm.vehicle,this.$refs.VehicleForm.isValid);
      if(result){
